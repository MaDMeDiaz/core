...
public class GuiPlayerTabOverlay extends Gui {
    ...
    public static List<NetworkPlayerInfo> getPlayerListTeams() {
        return field_175252_a.sortedCopy(Minecraft.getMinecraft().getNetHandler().getPlayerInfoMap());
    }
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        int i1 = Math.min(j4 * ((flag ? 9 : 0) + i + l + 13), width - 50) / j4 + 15;
    ...
    protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        if (ping <= 0) {
            ...
            color = Color.RED.darker().getRGB();
        }

        int pingWidth = mc.fontRendererObj.getStringWidth("" + ping);
        mc.fontRendererObj.drawStringWithShadow("" + ping, p_175245_2_ + p_175245_1_ - pingWidth, p_175245_3_, color);
    }
