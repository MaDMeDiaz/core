...
import com.envyclient.core.impl.events.MotionEvent;
import com.envyclient.core.impl.events.MoveEvent;
import com.envyclient.core.impl.events.SlowEvent;
import com.envyclient.core.impl.events.UpdateEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        EVENT.callEvent(move);
        super.moveEntity(move.getX(), move.getY(), move.getZ());
    }
    ...
    public void onUpdateWalkingPlayer() {
        ...
        MotionEvent pre = new MotionEvent(EventType.PRE, this.rotationYaw, this.rotationPitch, this.onGround, this.posY);
        EVENT.callEvent(pre);
        ...
        EVENT.callEvent(new MotionEvent(EventType.POST, this.rotationYaw, this.rotationPitch, this.onGround, this.posY));
    }
    ...
    public void sendMessage(String text) {
        Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(new ChatComponentText(ChatFormatting.WHITE + "(" + ChatFormatting.GREEN + NAME + ChatFormatting.WHITE + ") " + text));
    }

    public void sendLink(String link) {
        IChatComponent ichat = new ChatComponentText(ChatFormatting.WHITE + "(" + ChatFormatting.GREEN + NAME + ChatFormatting.WHITE + ") " + link);
    ...
    public void onLivingUpdate() {
        ...
        EVENT.callEvent(new UpdateEvent());
