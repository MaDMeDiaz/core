...
import com.envyclient.core.impl.events.TickEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private final Loader envy = new Envy();
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("textures/custom/icons/envy16.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("textures/custom/icons/envy32.png"));
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    EVENT.callEvent(new KeyPressEvent(k));
    ...
    private void middleClickMouse() {
        ...
        EVENT.callEvent(new MiddleClickEvent());
