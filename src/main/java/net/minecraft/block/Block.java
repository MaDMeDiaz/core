...
import com.envyclient.core.impl.events.LiquidCollideEvent;
...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (mc.thePlayer != null && mc.thePlayer == collidingEntity && this instanceof BlockLiquid) {
            LiquidCollideEvent eventLiquidCollide = new LiquidCollideEvent(axisalignedbb, pos.getX(), pos.getY(), pos.getZ());
            EVENT.callEvent(eventLiquidCollide);
            axisalignedbb = eventLiquidCollide.getBoundingBox();
        }
