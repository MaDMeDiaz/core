...
import com.envyclient.core.impl.events.SafeEvent;
import com.envyclient.core.impl.events.StepEvent;
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                ...
                StepEvent step = new StepEvent(this, this.stepHeight);
                EVENT.callEvent(step);
